// We will be hitting this endpoint: /api/course/createChapters
...
export async function POST(req: Request, res: Response) {
  try {
    ...
    if (session.user.credits <= 0 && !isPro) {
      // if credits below 0 or =0 or is not Pro member
    ...
    //to decrement credits by 1 everytime user creates a course
